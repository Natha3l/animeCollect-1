    ...
    <ThemedView style={tw`flex-1`}>
      ...
      <View style={tw`px-4 pt-6 pb-4`}>
        ...
        >
          ...
          <View style={tw`flex-row items-center bg-gray-100 dark:bg-gray-800 rounded-xl px-3 py-2`}>
            <TextInput
            ...
            {searchQuery.length > 0 || hasSearched ? (
              <TouchableOpacity
                ...
                style={tw`ml-2`}
              >
                <ThemedText style={tw`text-gray-500 dark:text-gray-300 font-bold`}>
                  Annuler
                </ThemedText>
              </TouchableOpacity>
            ) : (
          ...
          ListEmptyComponent={
            hasSearched ? (
              ...
              <View style={tw`px-4`}>
                  ...
                  <>
                    <View style={tw`flex-row justify-between items-center mb-2`}>
                      ...
                      <TouchableOpacity onPress={handleClearHistory}>
                        <ThemedText style={tw`text-sm text-blue-500 dark:text-blue-400`}>
                          Effacer
                        </ThemedText>
                      </TouchableOpacity>
                    </View>
                    {searchHistory.map((query, index) => (
                      <TouchableOpacity
                        ...
                        style={tw`py-3 border-b border-gray-200 dark:border-gray-700`}
                      >
                  ...
                  <View style={tw`flex-row flex-wrap`}>
                    {popularSearches.map((query, index) => (
                      <TouchableOpacity
                        key={index}
                        onPress={() => handleHistoryItemPress(query)}
                        style={tw`bg-gray-200 dark:bg-gray-700 rounded-full px-3 py-1 mr-2 mb-2`}
                      >
                ...
                <ThemedText style={tw`text-center mt-6 text-gray-500 dark:text-gray-400`}>
